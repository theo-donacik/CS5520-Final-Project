...
class SignInView: UIView {
    ...
    func setupUserTypeField() {
        userTypeLabel = UILabel()
        userTypeLabel.text = "User Type"
        userTypeLabel.font = .systemFont(ofSize: 16)
        userTypeLabel.translatesAutoresizingMaskIntoConstraints = false
        contentView.addSubview(userTypeLabel)

        userTypeButton = UIButton(type: .system)
        userTypeButton.setTitle("Select", for: .normal)
        userTypeButton.backgroundColor = .systemGray5
        userTypeButton.layer.cornerRadius = 6
        userTypeButton.translatesAutoresizingMaskIntoConstraints = false
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            userTypeLabel.topAnchor.constraint(equalTo: confirmPasswordField.bottomAnchor, constant: 16),
            userTypeLabel.leadingAnchor.constraint(equalTo: usernameLabel.leadingAnchor),
            userTypeLabel.widthAnchor.constraint(equalToConstant: 120),

            userTypeButton.centerYAnchor.constraint(equalTo: userTypeLabel.centerYAnchor),
            userTypeButton.leadingAnchor.constraint(equalTo: userTypeLabel.trailingAnchor, constant: 8),
            userTypeButton.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -16),
            userTypeButton.heightAnchor.constraint(equalToConstant: 44),
